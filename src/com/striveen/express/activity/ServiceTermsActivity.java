 ...
 * 
 */
public class ServiceTermsActivity extends MyActivity {
	/**
	 * 服务条款详细信息
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if ("1".equals(checkIntent)) {
			tv_title.setText(getString(R.string.index_lefSt_tv_invite));
			sv_info.loadUrl(GetDataConfing.ip1
					+ "/help/CustomerRecommend.html?id="
					+ getMyApplication().getUserId());
			Log.e("", "GetDataConfing:" + GetDataConfing.ip1
					+ "/help/CustomerRecommend.html?id="
					+ getMyApplication().getUserId());
		} else {
			tv_title.setText(getString(R.string.set_service_item));
			sv_info.loadUrl(GetDataConfing.ip1 + "/help/serviceitem.html");
		}

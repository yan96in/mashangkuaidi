 ...
 * 
 */
public class CourierGuideActivity extends MyActivity {
	/**
	 * 快递指南详细信息
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_title.setText(getString(R.string.user_setting_tv_4));
		sv_info.loadUrl(GetDataConfing.ip1 + "/help/quide.html");
	}

	public void iv_top_left(View v) {
		CourierGuideActivity.this.finish();
	}

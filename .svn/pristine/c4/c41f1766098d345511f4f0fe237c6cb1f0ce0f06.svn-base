...
import com.striveen.express.view.EventListener;
import com.striveen.express.view.Select;
import com.striveen.express.view.ViewInject;

public abstract class AFinalActivity extends Activity {
	private final String TAG = AFinalActivity.class.getSimpleName();

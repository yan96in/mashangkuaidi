package com.striveen.express.wheel.widget;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(TEXT_SIZE * itemsPaint.density);
	...
	/**
	 * Builds text depending on current value 修改 只显示前5个字符
	 * 
	...
	/**
	 * Returns the max item length that can be present 修改 只显示前5个字符
	 * 
